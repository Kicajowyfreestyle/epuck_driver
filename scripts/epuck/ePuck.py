...
class ePuck():
	...
	def set_body_led(self, led_value):
		...
		self._actuators_to_write.append(("L", 7, value))
	...
	def set_front_led(self, led_value):
		...
		self._actuators_to_write.append(("L", 1, value))

		if value == 0:
				self._leds_status[1] = False
		elif value == 1:
			self._leds_status[1] = True
		else:
			self._leds_status[1] = not self._leds_status[1]
