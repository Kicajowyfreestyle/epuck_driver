...
import PIL as Image          # Used for the pictures of the camera
...
class ePuck():
    ...
    def _read_sensors(self):
        ...
        def send_binary_mode(parameters):
            ...
            while len(reply) < parameters[1]:
                reply += self._recv()
            reply = struct.unpack(parameters[2], reply[-parameters[1]:])
    ...
    def set_body_led(self, led_value):
        ...
        if value == 0:
                self._leds_status[7] = False
        elif value == 1:
            self._leds_status[7] = True
        else:
            self._leds_status[7] = not self._leds_status[7]
    ...
    def set_front_led(self, led_value):
        ...
        if value == 0:
                self._leds_status[3] = False
        elif value == 1:
            self._leds_status[3] = True
        else:
            self._leds_status[3] = not self._leds_status[3]
